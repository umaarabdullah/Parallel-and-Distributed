...
@REM rem Execute the run_server target in a new terminal window
start "server" cmd /k cd /D "Client_Server_Parallel" ^& make run_server

@REM rem Add a delay to ensure the server has started before running clients (adjust as needed)
timeout /t 5
...
@REM start "client1_test_3" cmd /k cd /D "Client_Server_Parallel/tests" ^& make run_client1_test_3
@REM start "client2_test_3" cmd /k cd /D "Client_Server_Parallel/tests" ^& make run_client2_test_3
@REM start "client3_test_3" cmd /k cd /D "Client_Server_Parallel/tests" ^& make run_client3_test_3
